'''
While Loop Exercise
While loops are really hard for me to write test for(until we learn about things like lists),
...
* In order for my test to work, please add 1 to i each time through the loop. My test use this variable
    to check how many times your loops runs.
'''
