...
in this exercise c and y are two random variables. The code at the top of the file randomly assigns them 
(we´ll learn how it works later on). for now, just leave it alone.

1. If both are positive numbers, print "both positive".
1. If both are negative numbers, print "both negative".
